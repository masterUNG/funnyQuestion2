...
public class PostUnit2Fragment extends Fragment {
    ...
    public static PostUnit2Fragment postUnit2Instance(String uidString) {
        ...
        postUnit2Fragment.setArguments(bundle);
        return postUnit2Fragment;
    }
    ...
    private int calculatePretest() {
        ...
        Log.d(tag2, "scorePostTest==>" + sumScore);
        return sumScore;
    }
...
// find UnitID, Name Unit
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_postunit2, container, false);
        return view;
    }
